export const RPSTournamentABI = [
  ...
  },
  {
    ...
    "name": "playRound",
    "inputs": [
      {"name": "playerMove", "type": "uint8", "internalType": "enum RPSTournament.Move"}
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  {
    ...
    "outputs": [
      {"name": "state", "type": "uint8", "internalType": "enum RPSTournament.GameState"},
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"name": "playerBet", "type": "uint256", "indexed": false, "internalType": "uint256"}
    ],
    "anonymous": false
  },
  {
    ...
    "inputs": [
      ...
      {"name": "playerMove", "type": "uint8", "indexed": false, "internalType": "enum RPSTournament.Move"},
      {"name": "computerMove", "type": "uint8", "indexed": false, "internalType": "enum RPSTournament.Move"},
      {"name": "result", "type": "string", "indexed": false, "internalType": "string"}
    ],
    "anonymous": false
  },
  {
    ...
    "inputs": [
      {"name": "player", "type": "address", "indexed": true, "internalType": "address"},
      {"name": "result", "type": "string", "indexed": false, "internalType": "string"},
      {"name": "playerWins", "type": "uint256", "indexed": false, "internalType": "uint256"},
      {"name": "computerWins", "type": "uint256", "indexed": false, "internalType": "uint256"},
